...
<main>
    ...
    <section class="sub-service-industrial-waste__features">
          ...
          <details class="sub-service-detail__data-group" open>
            ...
            <div class="sub-service-detail__table-scroll">
              <table class="sub-service-detail__table" style="--service-detail-table-label-width: 55%;">
                <thead>
                  <tr><th scope="col">種類</th><th scope="col">備考</th></tr>
                </thead>
                <tbody>
                  <tr><th scope="row">廃プラスチック</th><td></td></tr>
                  <tr><th scope="row">木くず</th><td>伐木・生木・根除く</td></tr>
                  <tr><th scope="row">紙くず</th><td>※汚れ、濡れ不可</td></tr>
                  <tr><th scope="row">繊維くず（畳以外）</th><td>羊毛くず・木綿・藁・萱・絨毯など</td></tr>
                  <tr><th scope="row">上記可燃混合物</th><td>木くず・紙くず・繊維くず・廃プラスチックのみ</td></tr>
                  <tr><th scope="row">金属くず</th><td>※異物付着不可</td></tr>
                  <tr><th scope="row">ガラスくず</th><td>※ワイヤー、メッシュ入りは複合ガラスとして別途料金</td></tr>
                  <tr><th scope="row">アスファルト塊</th><td>80cm以上は別途料金</td></tr>
                  <tr><th scope="row">コンクリート塊</th><td>80cm以上は別途料金</td></tr>
                  <tr><th scope="row">管理型がれき類（サイディング、ケイカル板等）</th><td>紙質、木質などの異物混入分</td></tr>
                  <tr><th scope="row">コンクリート二次製品</th><td>80cm以上は別途料金</td></tr>
                  <tr><th scope="row">その他ガレキ類（煉瓦・瓦・陶磁器）</th><td>80cm以上は別途料金</td></tr>
                  <tr><th scope="row">上記混合物</th><td>石膏ボード・壁土・量及び石綿被疑材は対象外</td></tr>
                </tbody>
              </table>
            </div>
          </details>
          ...
          <details class="sub-service-detail__data-group" open>
            ...
            <div class="sub-service-detail__table-scroll">
              <table class="sub-service-detail__table" style="--service-detail-table-label-width: 50%;">
                ...
                <tbody>
                  <tr><th scope="row">生木</th><td></td></tr>
                  <tr><th scope="row">竹</th><td>根より上の部分（根は含まず）</td></tr>
                  <tr><th scope="row">竹・木の根</th><td></td></tr>
                  <tr><th scope="row">枕木</th><td></td></tr>
                  <tr><th scope="row">木毛板</th><td></td></tr>
                  <tr><th scope="row">超軽量物</th><td>発泡スチロール・グラスウール・ウレタンを分別必須 ※濡れ厳禁</td></tr>
                  <tr><th scope="row">浄化槽</th><td></td></tr>
                  <tr><th scope="row">漁網・ロープ・ネット</th><td>※金属類・その他異物付着不可</td></tr>
                  <tr><th scope="row">蛍光灯・電球</th><td>※破損及び割れている場合 別途料金</td></tr>
                  <tr><th scope="row">畳</th><td>※異物の付着厳禁</td></tr>
                  <tr><th scope="row">濡れ・腐食畳</th><td>※異物の付着厳禁</td></tr>
                  <tr><th scope="row">スプリング付ベッドマット（ダブル）</th><td>※ダブル以上の場合 別途料金</td></tr>
                  <tr><th scope="row">スプリング付ベッドマット（セミダブル）</th><td></td></tr>
                  <tr><th scope="row">スプリング付ベッドマット（シングル）</th><td></td></tr>
                  <tr><th scope="row">スプリング無ベッドマット</th><td>※厚み10cmまで</td></tr>
                  <tr><th scope="row">ソファ</th><td></td></tr>
                  <tr><th scope="row">自然石</th><td>巨石は別途お問合せ下さい。</td></tr>
                  <tr><th scope="row">壁土</th><td>ガレキ・木くず15cmまでその他混入不可 濡れる場合別途料金</td></tr>
                  <tr><th scope="row">解体ミンチ</th><td></td></tr>
                  <tr><th scope="row">消火器</th><td><span class="sub-service-detail__table-alert">※現在、受入停止</span></td></tr>
                  <tr><th scope="row">石膏ボード（乾燥している状態）</th><td></td></tr>
                  <tr><th scope="row">石膏ボード（濡れている状態）</th><td></td></tr>
                  <tr><th scope="row">タイヤ</th><td>※大型・特殊タイヤ 別途料金</td></tr>
                  <tr><th scope="row">バッテリー</th><td>※バッテリー廃液漏れ厳禁　<span class="sub-service-detail__table-alert">※現在、受入停止</span></td></tr>
                  <tr><th scope="row">複合素材（2種類の廃棄物が付着いる状態）</th><td>※形状・重さ・材質・量などにより決定</td></tr>
                  <tr><th scope="row">非飛散性石綿含有物（がれき類）</th><td></td></tr>
                  <tr><th scope="row">非飛散性石綿含有物（廃プラスチック類）</th><td>Pタイル等</td></tr>
                  <tr><th scope="row">塗料　水性に限る</th><td>水性に限る　<span class="sub-service-detail__table-alert">※現在、受入停止</span></td></tr>
                  <tr><th scope="row">動物性植物性残渣</th><td>※現在、受入停止</td></tr>
                  <tr><th scope="row">汚泥</th><td>有機物に限る　※現在、受入停止</td></tr>
                  <tr><th scope="row">機密書類</th><td><span class="sub-service-detail__table-alert">※現在、受入停止</span></td></tr>
                  <tr><th scope="row">ゴムキャタ</th><td>サイズにより変動</td></tr>
                </tbody>
              </table>
            </div>
          ...
          <details class="sub-service-detail__data-group" open>
            ...
            <div class="sub-service-detail__table-scroll">
              <table class="sub-service-detail__table sub-service-industrial-waste__sales-table" style="--service-detail-table-label-width: 33.333%;">
                <thead>
                  <tr><th scope="col">商品名</th><th scope="col">価格</th><th scope="col">備考</th></tr>
                </thead>
                <tbody>
                  <tr><th scope="row">再生砕石 RC40</th><td>0.6円/kg</td><td>駐車場などの砂利や路盤材に使用可能。<br>
                    工場渡し。（運搬も可能※条件応相談）</td></tr>
                </tbody>
              </table>
            </div>
          </details>
      ...
      <div class="sub-service-industrial-waste__process-inner inner">
        ...
        <div class="sub-service-industrial-waste__process-panel">
          <div class="sub-service-industrial-waste__process-layout">
            ...
            <div class="sub-service-industrial-waste__process-branch" aria-hidden="true"></div>
        ...
        <div class="sub-service-industrial-waste__recycling-list">
          <article class="sub-service-industrial-waste__recycling-card">
            ...
            <div class="sub-service-industrial-waste__recycling-body">
              <p class="sub-service-industrial-waste__recycling-description">日用品の容器、袋、フタ、フィルムなど</p>
              <p class="sub-service-industrial-waste__recycling-label">処理後</p>
              <ol class="sub-service-industrial-waste__recycling-result">
                <li>ビニール系→発電用燃料、固形燃料</li>
                <li>硬質プラスチック→プラスチック原料</li>
                <li>塩ビパイプ→原料</li>
                <li>その他→弊社でリサイクル不可物は他社へ再生委託いたします。</li>
              </ol>
              <ul class="sub-service-industrial-waste__recycling-tags">
                <li>圧縮</li><li>粉砕</li><li>選別</li><li>焼却</li>
              </ul>
            </div>
          </article>
          ...
          <article class="sub-service-industrial-waste__recycling-card">
            ...
            <div class="sub-service-industrial-waste__recycling-body">
              <p class="sub-service-industrial-waste__recycling-description">ダンボールや製紙工場、印刷工場から発生した廃棄紙など</p>
              <p class="sub-service-industrial-waste__recycling-label">処理後</p>
              <p class="sub-service-industrial-waste__recycling-result">ダンボール、トイレットペーパー、再生紙等</p>
              <ul class="sub-service-industrial-waste__recycling-tags">
                <li>圧縮</li><li>粉砕</li><li>選別</li><li>焼却</li>
              </ul>
            </div>
          ...
          <article class="sub-service-industrial-waste__recycling-card">
            ...
            <div class="sub-service-industrial-waste__recycling-body">
              <p class="sub-service-industrial-waste__recycling-description">木造建造物の木くず、木製家具など</p>
              <p class="sub-service-industrial-waste__recycling-label">処理後</p>
              <p class="sub-service-industrial-waste__recycling-result">製紙用原料、発電燃料</p>
              <a class="sub-service-industrial-waste__recycling-link" href="#">こちらからYOUTUBEにてリサイクル工程が見れますよ</a>
              <ul class="sub-service-industrial-waste__recycling-tags">
                <li>圧縮</li><li>粉砕</li><li>選別</li><li>焼却</li>
              </ul>
            </div>
          ...
          <article class="sub-service-industrial-waste__recycling-card">
            ...
            <div class="sub-service-industrial-waste__recycling-body">
              <p class="sub-service-industrial-waste__recycling-description">衣類、ベッドマットなどの繊維くずなど</p>
              <p class="sub-service-industrial-waste__recycling-label">処理後</p>
              <p class="sub-service-industrial-waste__recycling-result">発電用燃料<br>固形燃料</p>
              <ul class="sub-service-industrial-waste__recycling-tags">
                <li>圧縮</li><li>粉砕</li><li>選別</li><li>焼却</li>
              </ul>
            </div>
          ...
          <article class="sub-service-industrial-waste__recycling-card">
            ...
            <div class="sub-service-industrial-waste__recycling-body">
              <p class="sub-service-industrial-waste__recycling-description">各種金属部品、RC造・S造の鉄筋など</p>
              <p class="sub-service-industrial-waste__recycling-label">処理後</p>
              <p class="sub-service-industrial-waste__recycling-result">製鉄原料<br>非鉄原料<br>製鋼原料</p>
              <ul class="sub-service-industrial-waste__recycling-tags">
                <li>粉砕</li><li>選別</li>
              </ul>
            </div>
          ...
          <article class="sub-service-industrial-waste__recycling-card">
            ...
            <div class="sub-service-industrial-waste__recycling-body">
              <p class="sub-service-industrial-waste__recycling-description">解体時に発生した窓ガラスや便器などの陶器類など</p>
              <p class="sub-service-industrial-waste__recycling-label">処理後</p>
              <p class="sub-service-industrial-waste__recycling-result">埋め戻し材、路盤材</p>
              <ul class="sub-service-industrial-waste__recycling-tags">
                <li>粉砕</li><li>選別</li>
              </ul>
            </div>
          ...
          <article class="sub-service-industrial-waste__recycling-card">
            ...
            <div class="sub-service-industrial-waste__recycling-body">
              <p class="sub-service-industrial-waste__recycling-description">道路の改修工事、建造物の解体の際に発生したコンクリート、アスファルトなどのがれき類など</p>
              <p class="sub-service-industrial-waste__recycling-label">処理後</p>
              <ol class="sub-service-industrial-waste__recycling-result">
                <li>コンクリートガラ→路盤材</li>
                <li>アスファルトガラ→路盤材</li>
                <li>瓦→埋め戻し材（水道などで使用します）</li>
                <li>その他ガレキ類、モルタル・サイディング・陶器・タイル・ガラス・その他等（石綿含有物は除く）→埋戻し材、路盤材</li>
              </ol>
              <ul class="sub-service-industrial-waste__recycling-tags">
                <li>粉砕</li><li>選別</li>
              </ul>
          ...
          <article class="sub-service-industrial-waste__recycling-card">
            ...
            <div class="sub-service-industrial-waste__recycling-body">
              <p class="sub-service-industrial-waste__recycling-description">内壁や天井材として使用されている石膏ボードなど</p>
              <p class="sub-service-industrial-waste__recycling-label">処理後</p>
              <p class="sub-service-industrial-waste__recycling-result">石膏→路盤材、建設資材<br>紙くず→製紙原料</p>
              <ul class="sub-service-industrial-waste__recycling-tags">
                <li>粉砕</li><li>選別</li>
              </ul>
            </div>
          ...
          <ol class="site-flow__list">
            ...
            <li class="site-flow__item">
              ...
              <div class="site-flow__content">
                ...
                <p class="site-flow__text">お電話、LINE、メールにて弊社事務所まで所定の依頼書お送りいただきその後、現場にお伺いします。そして必要な情報をご提供いただき、使用用途に応じて、ご希望のサイズのコンテナを設置させていただきます。</p>
              </div>
            </li>
            ...
            <li class="site-flow__item">
              ...
              <div class="site-flow__content">
                ...
                <p class="site-flow__text">お電話、LINE、メールにて弊社事務所まで所定の依頼書お送りいただきその後、現場にお伺いします。<br>最短で翌日〜3日にて回収にお伺いたします。</p>
              </div>
            </li>
