...
<article class="sub-case-study__card">
  <a class="sub-case-study__card-link" href="<?php the_permalink(); ?>">
    ...
    <div class="sub-case-study__card-body">
      ...
      <span class="sub-case-study__link"><span>詳しくはこちら</span><span class="site-arrow-icon sub-case-study__link-icon" aria-hidden="true"><img src="<?php echo esc_url(get_theme_file_uri('/img/common/arrow-white.png')); ?>" alt=""></span></span>
    </div>
  </a>
</article>
