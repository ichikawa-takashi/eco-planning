...
<article class="sub-news__card">
  ...
  <div class="sub-news__card-body">
    ...
    <a class="sub-news__link" href="<?php the_permalink(); ?>"><span>詳しくはこちら</span><span class="site-arrow-icon sub-news__link-icon" aria-hidden="true"><img src="<?php echo esc_url(get_theme_file_uri('/img/common/arrow-white.png')); ?>" alt=""></span></a>
  </div>
</article>
