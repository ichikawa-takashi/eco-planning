      ...
      <div class="sub-recruit__message-inner">
        ...
        <div class="sub-recruit__message-content">
          ...
          <div class="sub-recruit__message-text">
            ...
            <p>
              うちには広告・アパレル・飲食・WEB通販など、まったくの異業種から飛び込んできた仲間が数多く活躍しています。解体の経験はまったく必要ありません。私がスキル以上に大切にしているのは、過去の自分からアップデートしようとする「学ぶ姿勢」「素直さ」「謙虚さ」です。
            </p>
            <p>
              私はこの会社を、上司や代表である私自身に対しても、納得のいかないことや自分の考えを率直にぶつけられる場所にしたいと思っています。
            </p>
            <p>
              あなたの柔軟な発想やアイデアが、新しいプロジェクトや社内ベンチャーとして形になるチャレンジの環境がこの会社には無限にあります。<br>
              ゼロから何かを生み出す面白さ、1を無限に拡大していくやりがいを、ぜひこの場所で一緒に味わってください。多様なバックグラウンドを持つ仲間とともに、世の中に「ワクワク」と「変化」を発信していきましょう。
            </p>
          </div>
          ...
          <div class="sub-recruit__message-links">
            ...
            <div class="sub-recruit__message-link-group">
              <p class="sub-recruit__message-link-title">media</p>
              <a class="sub-recruit__message-media-link" href="#">漫画ストーリー</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="sub-recruit__standard-inner inner">
          <div class="sub-recruit__standard-header">
            ...
            <div class="sub-recruit__standard-introduction">
              ...
              <p class="sub-recruit__standard-description">
                年齢、国籍、見た目のこだわり。私たちは全ての個性を尊重します。<br>
                多様な感性が混ざり合うことで、常識を越えた発想が生まれ、仲間も<br>
                お客様も笑顔になれるからです。
              </p>
            </div>
          </div>
          ...
          <div class="sub-recruit__standard-list">
            <article class="sub-recruit__standard-item">
              ...
              <div class="sub-recruit__standard-card">
                <h3 class="sub-recruit__standard-card-title">「常識を変える」ことに<br>ワクワクできる人</h3>
                <p class="sub-recruit__standard-card-text">
            ...
            <article class="sub-recruit__standard-item">
              ...
              <div class="sub-recruit__standard-card">
                <h3 class="sub-recruit__standard-card-title">「異業種での経験」を<br>新しい力に変えられる人</h3>
                <p class="sub-recruit__standard-card-text">
            ...
            <article class="sub-recruit__standard-item">
              ...
              <div class="sub-recruit__standard-card">
                <h3 class="sub-recruit__standard-card-title">「視野が広く」柔軟な発想が<br>できる人</h3>
                <p class="sub-recruit__standard-card-text">
            ...
            <article class="sub-recruit__standard-item">
              ...
              <div class="sub-recruit__standard-card">
                <h3 class="sub-recruit__standard-card-title">「素直さ」「謙虚さ」を<br>持っている人</h3>
                <p class="sub-recruit__standard-card-text">
            ...
            <article class="sub-recruit__standard-item">
              ...
              <div class="sub-recruit__standard-card">
                <h3 class="sub-recruit__standard-card-title">既成の「ルールや常識」に<br>縛られない人</h3>
                <p class="sub-recruit__standard-card-text">
            ...
            <article class="sub-recruit__standard-item">
              ...
              <div class="sub-recruit__standard-card">
                <h3 class="sub-recruit__standard-card-title">「6割スタート」でも動ける、<br>スピード感のある人</h3>
                <p class="sub-recruit__standard-card-text">
            ...
            <article class="sub-recruit__standard-item">
              ...
              <div class="sub-recruit__standard-card">
                <h3 class="sub-recruit__standard-card-title">自分の意見や想いを「素直に発信」<br>できる人</h3>
                <p class="sub-recruit__standard-card-text">
