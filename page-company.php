      ...
      <div class="sub-company__history-slider-shell inner">
        <div class="sub-company__history-slider swiper js-company-history-slider">
          <div class="swiper-wrapper">
            ...
            <article class="sub-company__history-card swiper-slide">
              <p class="sub-company__history-year">1975</p>
              <p class="sub-company__history-text">
            ...
            <article class="sub-company__history-card swiper-slide">
              <p class="sub-company__history-year">1976</p>
              <p class="sub-company__history-text">
            ...
            <article class="sub-company__history-card swiper-slide">
              <p class="sub-company__history-year">1983</p>
              <p class="sub-company__history-text">
            ...
            <article class="sub-company__history-card swiper-slide">
              <p class="sub-company__history-year">1991</p>
              <p class="sub-company__history-text">
            ...
            <article class="sub-company__history-card swiper-slide">
              <p class="sub-company__history-year">1995</p>
              <p class="sub-company__history-text">
            ...
            <article class="sub-company__history-card swiper-slide">
              <p class="sub-company__history-year">2011</p>
              <p class="sub-company__history-text">
                吉田實が代表取締役に就任。
              </p>
            ...
            <article class="sub-company__history-card swiper-slide">
              <p class="sub-company__history-year">2014</p>
              <p class="sub-company__history-text">
            ...
            <article class="sub-company__history-card swiper-slide">
              <p class="sub-company__history-year">2015</p>
              <p class="sub-company__history-text">
      ...
      <div class="sub-company__data-inner inner">
        ...
        <dl class="sub-company__data-list">
          ...
          <div class="sub-company__data-row">
            ...
            <dd class="sub-company__data-description">
              <ul class="sub-company__data-lines">
                <li>・津商工会議所</li>
                <li>・鈴鹿商工会議所</li>
                <li>・一般社団法人三重県産業廃棄物協会</li>
                <li>・三重県SDGs推進パートナー</li>
                <li>・一般社団法人M-EMS認証機構</li>
                <li>・東京臨海ロータリークラブ</li>
                <li>・一般社団法人JCU</li>
              </ul>
            </dd>
          ...
          <div class="sub-company__data-row">
            ...
            <dd class="sub-company__data-description">
              <ul class="sub-company__data-lines">
                <li>8:00〜17:00（土曜日、祝日も対応）</li>
                <li>・日曜日、GW、お盆、年末年始</li>
              </ul>
            </dd>
          </div>
          <div class="sub-company__data-row">
            ...
            <dd class="sub-company__data-description">
              ...
              <p class="sub-company__data-line">三重県・愛知県を中心に全国対応可</p>
              <p class="sub-company__data-area-label">収集運搬：</p>
              <p class="sub-company__data-line">三重県、愛知県、岐阜県、東京都、千葉県、埼玉県、神奈川県、石川県、富山県、滋賀県、奈良県、京都府、大阪府、兵庫県</p>
              <p class="sub-company__data-area-note">その他の県も協業企業によって回収運搬も可能です。お気軽にご相談ください。</p>
            </dd>
          </div>
        </dl>
      </div>
